...
const Home = () => {
  ...
  return (
    <section className="body-font w-full flex-1 text-gray-600">
      <div className="container mx-auto px-5 py-5">
        ...
        {/* component */}
        <div className="-m-4 my-1 flex w-full flex-wrap justify-evenly">
          <EntityComponent name={"owner"} image={OwnerImage} />
          <EntityComponent name={"supplier"} image={SupplierImage} />
        </div>
