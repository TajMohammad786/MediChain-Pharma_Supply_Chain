...
const ViewTransactions = () => {
  ...
  async function getTxnData() {
    ...
    const txnsList = txns.map(data => (
      <tr key={data[0]} className="border-b bg-gray-100">
        <td className="px-6 py-4 whitespace-normal overflow-hidden">
  ...
  return (
    ...
    <h1 className="m-2">Transactions List</h1>
        ...
        <table className="w-full bg-white text-left text-sm text-gray-500">
          <thead className="dark-bg-gray-400 bg-gray-50 text-xs uppercase text-gray-900">
            <tr>
              ...
              <th scope="col" className="px-6 py-3" style={{ width: '28%' }}>
                Timestamp
              </th>
            </tr>
          </thead>
