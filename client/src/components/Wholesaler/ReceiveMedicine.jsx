...
const WholesalerReceiveMedicine = () => {
  ...
  async function handleSubmit() {
    ...
    if(verificationOutput) {
      ...
      supplyChain.methods.wholesalerReceivedMedicine(address, manufacturer, signature).send({from: account, gas: 3000000})
...
export default WholesalerReceiveMedicine
