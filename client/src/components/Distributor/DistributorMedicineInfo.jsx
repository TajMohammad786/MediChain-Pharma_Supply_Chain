...
const WholesalerMedicineInfo = () => {
  ...
  const [details, setDetails] = useState({
    ...
    const  getMedicineData = async()=> {
        ...
        let subcontractAddressWD = await supplyChain.methods.getSubContractWD(address).call({ from: account });
        let subcontractAddressDC = await supplyChain.methods.getSubContractDC(address).call({ from: account });
