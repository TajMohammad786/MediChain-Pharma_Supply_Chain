...
const GenerateSignature = () => {
    ...
    const generateSignature = async () => {
        ...
        const signature = await web3.eth.accounts.sign(formData.packageAddr, formData.privateKey);
    ...
    const onRequest = async (e) => {
      e.preventDefault();
      // isLoading(true);
      supplyChain.methods.requestProduct(account, formData.supplierAddr, formData.packageAddr, formData.signature).send({ from: account })
